...
public class MyJToggleButton extends JToggleButton implements Editable  {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4121179362188281833L;
	private String text, name, source, eventHandler, mnemonicVal, scope="local", type="JToggleButton";
	...
	public MyJToggleButton(String text, int x, int y, int width, int height) {
		setText(text);
		this.name=text;
		this.x=x;
		this.y=y;
	...
	public String describeInCode() {
		String code = "\n\t\t//Add JToggleButton "+name;
		if (scope.equals("local")) code+="\n\t\tJToggleButton "+name+" = new JToggleButton(\""+getText()+"\");";
		else code+="\n\t\t"+name+" = new JToggleButton(\""+text+"\");";
	...
	public String toString() {
		return "JToggleButton ["+name+"]"+getPropertyValues()+"~"+x+"~"+y;
	}
	
	@Override
	public String getHeaderInfo() {
		//return "import javax.swing.JToggleButton;\n";
		return "";
	}

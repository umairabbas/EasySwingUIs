...
public class MyJRadioButtonMenuItem extends JRadioButtonMenuItem implements MenuObject {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2232345829267690572L;
	private String name, text, source, actionPerformed, accelerator, mnemonicVal, scope="local", type="JRadioButtonMenuItem";
	private MyJMenu parent;
	private boolean isChecked=false;
	private ArrayList<String> propertyNames, propertyValues;
	
	public MyJRadioButtonMenuItem(String name, String text, MyJMenu parent) {
		this.name=name;
		this.text=text;
		this.parent=parent;
		setText(text);
	...
	public String describeInCode() {
		String code="\n\t\t//JRadioButtonMenuItem "+name;
		if (scope.equals("local")) code+="\n\t\tJRadioButtonMenuItem "+name+"=new JRadioButtonMenuItem(\""+text+"\");";
		else code+="\n\t\t"+name+"=new JRadioButtonMenuItem(\""+text+"\");";
		...
		if (propertyValues.get(6).substring(0,propertyValues.get(6).indexOf(',')).length()>0) code+="\n\t\t"+name+".addActionListener(new ActionListener() {"+"\n\t\t\t@Override\n\t\t\tpublic void actionPerformed(ActionEvent e) {\n\t\t\t\t"+propertyValues.get(6).substring(0,propertyValues.get(6).indexOf(','))+"\n\t\t\t}\n\t\t});";
	...
	public String toString() {
		return "JRadioButtonMenuItem ["+name+"]"+getPropertyValues()+"~"+parent.getName();
	}
	...
	public String getHeaderInfo() {
		//return "import javax.swing.JRadioButtonMenuItem;\n";
		return "";
	}
